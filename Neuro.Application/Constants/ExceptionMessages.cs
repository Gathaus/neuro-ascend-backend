namespace Neuro.Application.Constants;
...
public class ExceptionMessages
{
    ...
    public const string EntityNotFoundTitle = "Entity Not Found";
    public const string EntityNotFoundDetail = "The requested entity could not be found.";
